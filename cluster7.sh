...
/home/sm3934/miniconda3/envs/rpcrl_env/bin/python /project/ag2682/sm3934/RCRL_on_RCMDP/code_ipm_rcmdp_rcrl_max_quadrotor_multi_constraint_FAC.py --run 501 --persistent_eps 0.5 --beta 30000 --K_epochs 5 --max_train_steps 35000 --warm_start_episode 1000 --lr_cost 5e-4 --lr_c 5e-4 --lr_a 5e-4 --entropy_coef 0.007 --weight_reg 0.0 --seed 2 --batch_size 1024 --mini_batch_size 256 --cost_scale 100.0
