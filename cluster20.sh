...
/home/sm3934/miniconda3/envs/rpcrl_env/bin/python /project/ag2682/sm3934/RCRL_on_RCMDP/code_ipm_rcmdp_rcrl_max_hc_feasible_policy.py --run 43 --persistent_eps 0.1 --beta 3000 --K_epochs 5 --max_train_steps 8000 --warm_start_episode 500 --lr_cost 1e-3 --entropy_coef 0.001 --weight_reg 0.001 --seed 42 --env HalfCheetahWithPosPerturbed --lr_c 5e-3 --sigma_gravity 2.0
