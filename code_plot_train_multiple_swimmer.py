...
data_dirs = [
    "./plot_data/SwimmerWithPos",
    "./plot_data/SwimmerWithPosPerturbed",
    # "./plot_data/CartPolePerturbedEnv"
]
...
plot_mean_std_multiple_dirs(data_dirs, labels, num_runs_list, save=True, base_filename="train_plots/Swimmer_training", smooth_window=80)
