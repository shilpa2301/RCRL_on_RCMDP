...
# ============================================================
# Swimmer plot specs
# Fill the missing paths and run numbers.
# Known paths are filled from your message.
# ============================================================
swimmer_plot_specs = [
    {
        "data_dir": "./plot_data/SwimmerWithPos",
        "label": "Surrogate Obj",
        "runs": [1, 2]
    },
    {
    ...
    {
        "data_dir": "./plot_data/SwimmerWithPos_PD_RESPO",
        "label": "RESPO",
        "runs": [1, 2]
    },
    {
...
plot_mean_std_multiple_runs(
    plot_specs=swimmer_plot_specs,
    save=True,
    base_filename="train_plots/swimmer_training_all",
    smooth_window=80,
    save_legends=False,
    max_episodes=16000
)
