...
/home/sm3934/miniconda3/envs/ipm_rcrl_env/bin/python /project/ag2682/sm3934/RCRL_on_RMDP/code_ipm_rcmdp_rcrl_max3.py --run 1 --seed 1 --env CartPolePerturbedEnv --persistent_eps 0.7 --beta 25.0 --max_train_steps 5000
