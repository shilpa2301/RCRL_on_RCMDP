...
# ============================================================
# Hopper plot specs
# Fill the run numbers.
# Paths are filled based on your message.
# ============================================================
hopper_plot_specs = [
    {
        "data_dir": "./plot_data/HopperCostEnv",
        "label": "Surrogate Obj",
        "runs": [1, 2]
    },
    {
        "data_dir": "./plot_data/HopperPerturbedEnv",
        "label": "Ours",
        "runs": [1,2]
    },
    {
        "data_dir": "./plot_data/HopperCostEnv_PD_RESPO",
        "label": "RESPO",
        "runs": [1,2]
    },
    {
...
plot_mean_std_multiple_runs(
    plot_specs=hopper_plot_specs,
    save=True,
    base_filename="train_plots/hopper_training_all",
    smooth_window=80,
    save_legends=False,
    max_episodes=5500
)
