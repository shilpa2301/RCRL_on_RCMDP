...
from code_ipm_rcmdp_rcrl_max_hopper import (
    Actor_Beta,
    Actor_Gaussian,
    Actor_Discrete,
    Critic,
...
from envs.hopper import HopperPerturbedEnvTest
...
def test_agent_single_model(
    ...
    """
    Evaluate one saved Hopper model.
    """
...
def plot_evaluation_single(
    ...
    """
    Plot evaluation results for one Hopper model per method.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default="HopperCostEnv")
    ...
    # ============================================================
    # Single Hopper evaluation only.
    #
    # Based on your training plot:
    #
    #   HopperCostEnv:
    ...
    #       Ours runs [1, 2]
    #
    #   HopperCostEnv_PD_RESPO:
    #       RESPO runs [1, 2]
    #
    # Current/first-run choices:
    #   Surrogate Obj -> run1
    #   Ours          -> run1
    #   RESPO         -> run1
    #   PD            -> run103
    ...
    model_specs = [
        ...
        {
            "label": "PD",
            "model_path": "./models/HopperCostEnv/run103/Best_RCAC"
        },
        {
            "label": "FAC",
            "model_path": "./models/HopperCostEnv/run501/Best_RCAC"
        },
        {
            "label": "RCRL",
            "model_path": "./models/HopperCostEnv/run101/Best_RCAC"
        },
        {
            "label": "RESPO",
            "model_path": "./models/HopperCostEnv_PD_RESPO/run1/Best_RCAC"
        },
    ]
    ...
    plot_evaluation_single(
        ...
        perturbation_stds=perturbation_stds,
        save=True,
        base_filename="plot_inference/hopper_inference_all",
        smooth_window=20,
        save_legends=False
    )
