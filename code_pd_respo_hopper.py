...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default="HopperCostEnv",
        help="HopperPerturbed/HopperCostEnv/CartPolePerturbedEnv/CartPoleCostEnv/PendulumEnv/PendulumCostEnv/HalfCheetahWithPos/HalfCheetahWithPosPerturbed",
    )
