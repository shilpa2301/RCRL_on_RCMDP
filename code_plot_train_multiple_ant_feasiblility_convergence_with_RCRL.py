...
# ============================================================
# Color scheme for this comparison
# ============================================================
METHOD_COLORS = {
...
def plot_mean_std_multiple_runs(
    plot_specs,
    save=False,
    base_filename="sample_complexity",
    smooth_window=80,
    save_legends=True,
    max_episodes=5500,
    ...
    """
    Compare training sample complexity for feasible vs infeasible initialization.

    plot_specs format:
        [
            {
                "data_dir": "./plot_data/AntCostPerturbed",
                "label": "Infeasible",
                "runs": [1, 2],
            },
            {
...
# ============================================================
# Fill these paths and run numbers
# ============================================================

BASE_DATA_DIR = "./plot_data/AntCostPerturbed"
BASE_RCRL_DIR = "./plot_data/AntCost"
...
plot_mean_std_multiple_runs(
    plot_specs=plot_specs,
    save=True,
    base_filename="train_plots/ant_sample_complexity_feasible_vs_infeasible_RCRL",
    smooth_window=80,
    save_legends=True,
    max_episodes=5500,
    baseline_cost_threshold=0.1,
