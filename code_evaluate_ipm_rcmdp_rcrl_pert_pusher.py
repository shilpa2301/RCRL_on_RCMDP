...
def test_multiple_dirs(args, save_paths, perturbation_stds, num_episodes=100):
    ...
    for save_path in save_paths:
        ...
        for std in perturbation_stds:
            ...
            env = PusherWithCost(sigma_viscosity=std, max_steps=100)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--env", type=str, default='PusherWithCost',help="HopperPerturbed/CartPolePerturbedEnv/CartPoleCostEnv")
