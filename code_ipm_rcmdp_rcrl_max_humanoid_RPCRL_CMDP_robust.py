...
from envs.humanoid import HumanoidCMDP, HumanoidCMDPPerturbed
...
class PrimalDual:
    def __init__(self, args):
        ...
        elif args.env == "HumanoidCMDPPerturbed":
            self.env = HumanoidCMDPPerturbed(sigma_gravity=args.sigma_gravity)
        else:
...
def evaluate_policy(args, env, agent, state_norm=None, reward_scaling=None):
    ...
    for _ in range(times):
        s, _ = env.reset(seed=args.seed)#[0][0]
...
def main(args, run_number):
    ...
    if args.env == "HumanoidCMDP":
        ...
        env = ( HumanoidCMDPPerturbed(sigma_gravity=args.sigma_gravity) )
        env_evaluate = ( HumanoidCMDPPerturbed(sigma_gravity=args.sigma_gravity) )
        env_reset = HumanoidCMDPPerturbed(sigma_gravity=args.sigma_gravity)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        help="HumanoidCMDP/HumanoidCMDPPerturbed",
    )
