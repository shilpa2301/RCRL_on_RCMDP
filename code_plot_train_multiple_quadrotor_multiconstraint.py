...
def load_cost_array(path, cost_dim=4, max_episodes=None, name="costs"):
    """
    Loads episode_max_costs.npy.

    Expected multi-constraint shape:
        [episodes, cost_dim]
...
# ============================================================
# Main Quadrotor plotting function
# ============================================================
def plot_quadrotor_multiconstraint_training(
    plot_specs,
    save=False,
    base_filename="quadrotor_training",
    smooth_window=10,
    save_legends=True,
    max_episodes=5500,
    cost_dim=4,
    ...
    """
    Plot mean/std across multiple runs for Quadrotor multi-constraint training.

    This version produces exactly 3 saved plots:
...
# ============================================================
# Quadrotor plot specs
# ============================================================
quadrotor_plot_specs = [
    {
        "data_dir": "./plot_data/quadrotor",
        "label": "Surrogate Obj",
        "runs": [1, 2],
    },
    {
...
plot_quadrotor_multiconstraint_training(
    plot_specs=quadrotor_plot_specs,
    save=True,
    base_filename="train_plots/quadrotor_training_all",
    smooth_window=80,
    save_legends=False,
    max_episodes=25000,
    cost_dim=4,
