...
def smooth(data, window_size):
    ...
    If data is shorter than window_size, return original data.
    """
...
# ============================================================
# Color scheme for feasible vs infeasible comparison
# Colors exchanged:
#   Infeasible -> blue
#   Feasible   -> red
# ============================================================
METHOD_COLORS = {
    "Infeasible Ours": "#1f77b4",  # blue
    "Feasible Ours": "#d62728",    # red
    "Infeasible RCRL": "#9467bd",
    "Feasible RCRL": "#8c564b",
    "Baseline": "black",
}
...
def plot_mean_std_multiple_runs(
    plot_specs,
    save=False,
    base_filename="hc_sample_complexity",
    smooth_window=80,
    save_legends=True,
    max_episodes=16000,
    ...
    """
    Compare HalfCheetah training sample complexity for feasible vs infeasible initialization.
    ...
    for spec in plot_specs:
        ...
        x = np.arange(len(smoothed_mean_rewards))
    ...
    for spec in plot_specs:
        ...
        x = np.arange(len(smoothed_mean_max_costs))
...
# ============================================================
# HalfCheetah feasible vs infeasible runs
# ============================================================

BASE_DATA_DIR = "./plot_data/HalfCheetahWithPosPerturbed"
BASE_RCRL_DIR = "./plot_data/HalfCheetahWithPos"

plot_specs = [
    {
        "data_dir": BASE_DATA_DIR,
        "label": "Infeasible Ours",
        # Replace these with your original/infeasible runs
        "runs": [1, 2],
    },
    {
        "data_dir": BASE_DATA_DIR,
    ...
    {
        "data_dir": BASE_RCRL_DIR,
        "label": "Infeasible RCRL",
        # Replace these with your original/infeasible runs
        "runs": [101, 102],
    },
    {
...
plot_mean_std_multiple_runs(
    plot_specs=plot_specs,
    save=True,
    base_filename="train_plots/HC_sample_complexity_feasible_vs_infeasible_RCRL",
    smooth_window=80,
    save_legends=False, #True,
    max_episodes=8000,
    baseline_cost_threshold=0.1,
)
