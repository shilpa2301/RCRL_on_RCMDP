...
def smooth(data, window_size):
    ...
    If the data is shorter than the window size, return original data.
    """
...
# ============================================================
# Color scheme for Humanoid ablation study
# Keep b=30000 as Ours blue
# ============================================================
METHOD_COLORS = {
    "b=30000": "#1f77b4",   # Ours blue
    "b=300": "#ff7f0e",     # orange
    "b=3000": "#2ca02c",    # green
    # "30 beta": "#9467bd",   # purple
    "Baseline": "black"
}
...
def get_method_color(label):
    """
    Return fixed color for known labels.
...
def save_separate_legends(
    ...
    # Horizontal legend
    # ============================================================
    fig_horizontal = plt.figure(figsize=(34, 4))
    ...
    # Vertical legend
    # ============================================================
    fig_vertical = plt.figure(figsize=(12, 14))
...
def plot_mean_std_multiple_runs(
    plot_specs,
    save=False,
    base_filename="humanoid_b_ablation",
    smooth_window=80,
    save_legends=True,
    max_episodes=5500,
    ...
    """
    Plot mean/std rewards and max costs for Humanoid ablation study.
...
plot_mean_std_multiple_runs(
    plot_specs=plot_specs,
    save=True,
    base_filename="train_plots/humanoid_b_ablation",
    smooth_window=80,
    save_legends=True,
    max_episodes=6000,
