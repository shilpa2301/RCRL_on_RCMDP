...
from code_ipm_rcmdp_rcrl_max_ant import (
    Actor_Beta,
    Actor_Gaussian,
    Actor_Discrete,
    Critic,
...
from envs.ant import AntCost, AntCostDampingPerturbedTest
...
def safe_reset_env(env, seed=None):
    ...
    # Original Ant code used env.reset()[0][0].
    # This keeps compatibility if reset output is nested.
    while state.ndim > 1:
        state = state[0]
...
def test_single_models(
    ...
    model_specs format:
        [
            {
                "label": "Ours",
                "model_path": "./models/AntCostPerturbed/run1/Best_RCAC"
            }
        ]
    ...
    for spec in model_specs:
        ...
        for std in perturbation_stds:
            ...
            env = AntCostDampingPerturbedTest(sigma_damping=std)
...
def plot_evaluation_single(
    ...
    """
    Plot evaluation results for one Ant model per method.
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--env",
        type=str,
        default="AntCostDampingPerturbedTest",
        help="AntCost/AntCostPerturbed"
    )
    ...
    # ============================================================
    # Single Ant evaluation only.
    #
    # Current code kept:
    #   Surrogate Obj: ./models/AntCost/run2/Best_RCAC
    #   Ours:          ./models/AntCostPerturbed/run1/Best_RCAC
    #
    # Other methods use first run placeholders where available.
    # Fill/adjust paths if your folder names differ.
    # ============================================================
    model_specs = [
        {
            "label": "Ours",
        ...
        {
            "label": "Surrogate Obj",
            "model_path": "./models/AntCost/run2/Best_RCAC"
        },
        {
            "label": "PD",
            "model_path": "./models/AntCost/run103/Best_RCAC"
        },
        {
            "label": "FAC",
            "model_path": "./models/AntCost/run501/Best_RCAC"
        },
        {
            "label": "RCRL",
        ...
        {
            "label": "RESPO",
            "model_path": "./models/AntCost_PD_RESPO/run1/Best_RCAC"
        },
    ]
    ...
    plot_evaluation_single(
        ...
        perturbation_stds=perturbation_stds,
        save=True,
        base_filename="plot_inference/ant_inference_all_damping",
        smooth_window=20,
        save_legends=False
    )
