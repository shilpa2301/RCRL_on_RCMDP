...
/home/sm3934/miniconda3/envs/rpcrl_env/bin/python /project/ag2682/sm3934/RCRL_on_RCMDP/code_ipm_rcmdp_rcrl_max_humanoid_RPCRL_CMDP.py --run 101 --persistent_eps 100 --K_epochs 5 --max_train_steps 10000 --warm_start_episode 300 --lr_cost 1e-4 --lr_a 1e-3 --entropy_coef 0.01 --weight_reg 0.0 --seed 6 --env HumanoidActionCostCMDP --lr_c 5e-4
