...
/home/sm3934/miniconda3/envs/rpcrl_env/bin/python /project/ag2682/sm3934/RCRL_on_RCMDP/code_ipm_rcmdp_rcrl_max_hc_sparse.py --run 1 --persistent_eps 0.2 --K_epochs 5 --max_train_steps 16000 --warm_start_episode 500 --lr_cost 5e-4 --entropy_coef 0.001 --weight_reg 0.0 --seed 7 --env HalfCheetahForwardObstacleCMDP --lr_c 5e-4 --sigma_gravity 0.0
