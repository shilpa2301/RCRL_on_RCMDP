...
/home/sm3934/miniconda3/envs/ipm_rcrl_env/bin/python /project/ag2682/sm3934/RCRL_on_RMDP/code_ipm_rcmdp_rcrl_max.py --run 2 --seed 2 --env CartPoleCostEnv --persistent_eps 2.0 --beta 25.0 --max_train_steps 5000
