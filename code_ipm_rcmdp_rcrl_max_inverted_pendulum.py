...
from envs.inverted_pendulum import InvertedPendulumWithCost, InvertedPendulumWithCostPerturbed
...
class RPCRL:
    def __init__(self, args):
        ...
        if args.env == "InvertedPendulumWithCost":
            self.env = InvertedPendulumWithCost(sigma_gravity=0.0, max_steps=1000)
        elif args.env == "InvertedPendulumWithCostPerturbed":
            self.env = InvertedPendulumWithCostPerturbed(sigma_gravity=args.sigma_gravity, max_steps=1000)
...
def main(args, run_number):
    ...
    if args.env == "InvertedPendulumWithCost":
        env = (InvertedPendulumWithCost(sigma_gravity=0.0, max_steps=1000))  
        env_evaluate = (InvertedPendulumWithCost(sigma_gravity=0.0, max_steps=1000))  
        env_reset = InvertedPendulumWithCost(sigma_gravity=0.0, max_steps=1000)
    elif args.env == "InvertedPendulumWithCostPerturbed":
        env = (InvertedPendulumWithCostPerturbed(sigma_gravity=args.sigma_gravity, max_steps=1000))  
        env_evaluate = (InvertedPendulumWithCostPerturbed(sigma_gravity=args.sigma_gravity, max_steps=1000))  
        env_reset = InvertedPendulumWithCostPerturbed(sigma_gravity=args.sigma_gravity, max_steps=1000)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="InvertedPendulumWithCost",
        help="InvertedPendulumWithCost/InvertedPendulumWithCostPerturbed",
    )
