...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="ReacherWithCost",
        help="HopperPerturbed/CartPolePerturbedEnv/CartPoleCostEnv/PendulumEnv/PendulumCostEnv/HalfCheetahWithPos/ReacherWithCost",
    )
    ...
    parser.add_argument("--sigma_gravity", type=float, default=0.0, help="sigma of gravity perturbation")
