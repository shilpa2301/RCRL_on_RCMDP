...
def plot_mean_std_multiple_runs(
    plot_specs,
    save=False,
    base_filename="humanoid_sample_complexity_feasible_vs_infeasible",
    smooth_window=80,
    save_legends=True,
    max_episodes=5500,
    ...
    for feasible vs infeasible Humanoid runs.
...
# ============================================================
# Humanoid feasible vs infeasible plot specs
# ============================================================

BASE_DATA_DIR = "./plot_data/HumanoidWithCostPerturbed"
BASE_RCRL_DIR = "./plot_data/HumanoidWithCost"
...
plot_mean_std_multiple_runs(
    plot_specs=plot_specs,
    save=True,
    base_filename="train_plots/humanoid_sample_complexity_feasible_vs_infeasible_RCRL",
    smooth_window=80,
    save_legends=True,
    max_episodes=5500,
    baseline_cost_threshold=1.2
)
