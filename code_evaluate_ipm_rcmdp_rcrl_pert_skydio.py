...
from envs.skydio import SkydioTrackingEnv
...
if __name__ == "__main__":
    ...
    plot_evaluation(args, results, directories, perturbation_stds, labels, save=True, base_filename="plot_inference/ant_inference", smooth_window=20)
