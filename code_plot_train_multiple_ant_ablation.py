...
# ============================================================
# Color scheme for b ablation study
...
def save_separate_legends(
    ...
    # Horizontal legend
    # =====================
    fig_horizontal = plt.figure(figsize=(30, 4))
    ...
    # Vertical legend
    # =====================
    fig_vertical = plt.figure(figsize=(12, 12))
...
def plot_mean_std_multiple_runs(
    ...
    """
    Plot mean/std rewards and max costs for b ablation study.
...
plot_mean_std_multiple_runs(
    plot_specs=plot_specs,
    save=True,
    base_filename="train_plots/ant_b_ablation",
    smooth_window=80,
    save_legends=True,
    max_episodes=5500,
    baseline_cost_threshold=0.1
