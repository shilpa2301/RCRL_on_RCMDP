...
humanoid_feasible_infeasible_specs = [
    {
...
plot_mean_std_multiple_runs(
    plot_specs=humanoid_feasible_infeasible_specs,
    save=True,
    base_filename="train_plots/humanoid_sample_complexity_feasible_vs_infeasible",
    smooth_window=80,
    save_legends=True,
    max_episodes=5500,
