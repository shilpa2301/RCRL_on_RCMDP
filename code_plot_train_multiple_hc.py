...
def plot_mean_std_multiple_dirs(data_dirs, labels, num_runs_list, save=False, base_filename="aggregated_plot", smooth_window=10):
    ...
    for data_dir, label, num_runs in zip(data_dirs, labels, num_runs_list):
        ...
        all_rewards = np.array([r[:16000] for r in all_rewards])
    ...
    for data_dir, label, num_runs in zip(data_dirs, labels, num_runs_list):
        ...
        all_max_costs = np.array([c[:16000] for c in all_max_costs])
...
data_dirs = [
    "./plot_data/HalfCheetahWithPos",
    "./plot_data/HalfCheetahWithPosPerturbed",
    # "./plot_data/CartPolePerturbedEnv"
]
...
plot_mean_std_multiple_dirs(data_dirs, labels, num_runs_list, save=True, base_filename="train_plots/HC_training", smooth_window=80)
