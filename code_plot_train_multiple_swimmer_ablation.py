...
def plot_mean_std_multiple_runs(
    plot_specs,
    save=False,
    base_filename="swimmer_b_ablation",
    smooth_window=80,
    save_legends=True,
    max_episodes=16000,
    ...
    """
    Plot mean/std rewards and max costs for Swimmer b ablation study.
...
plot_mean_std_multiple_runs(
    plot_specs=plot_specs,
    save=True,
    base_filename="train_plots/swimmer_b_ablation",
    smooth_window=80,
    save_legends=True,
    max_episodes=8000,
    baseline_cost_threshold=0.1
