    ...
    def update(self, replay_buffer, total_steps):
        ...
        with torch.no_grad():  # adv and v_target have no gradient
            ...
            with torch.no_grad():
                ...
                vl_pi = vcs.max()
                # temperature = 0.001
                # vl_pi = temperature * torch.logsumexp(vcs / temperature, dim=0)
...
def main(args, run_number):
    ...
    args.max_episode_steps = 1000 #env.max_steps  # Must match environment's truncation limit
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="CartPoleCostEnv",
        help="HopperPerturbed/CartPolePerturbedEnv/CartPoleCostEnv/PendulumEnv/PendulumCostEnv",
    )
    ...
    parser.add_argument("--beta", type=float, default=25.0, help="beta 600")
    parser.add_argument("--run", type=int, default=5, help="run_number")
    parser.add_argument(
        "--warm_start_flag", type=int, default=0, help="warm_start_flag"
    )
    parser.add_argument(
        "--warm_start_episode", type=int, default=300, help="warm_start_episode"
    )
    parser.add_argument(
