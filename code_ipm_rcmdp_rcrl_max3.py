...
from envs.cartpole3 import CartPoleCostEnv, CartPolePerturbedEnv
...
def main(args, run_number):
    ...
    model_dir = f"./models/{args.env}_Cost3/run{run_number}/"
    data_train_dir = f"./data_train/{args.env}_Cost3/run{run_number}/"
    plot_data_dir = f"./plot_data/{args.env}_Cost3/run{run_number}/"
