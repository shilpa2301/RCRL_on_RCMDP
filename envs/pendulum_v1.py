...
class PendulumEnv(gym.Env):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def __init__(self, render_mode: Optional[str] = None, g=10.0):
        ...
        # Define max steps for an episode
        self.max_steps = 200
    ...
    def step(self, u):
        ...
        done = self.steps >= self.max_steps  # Check if maximum steps reached

        # if self.render_mode == "human":
        #     self.render()
        actual_cost = 0.0
        # if abs(theta)>0.8:
        #     actual_cost += abs(theta)-0.8
        return self._get_obs(), -costs, actual_cost, done, False, {}
...
class PendulumPerturbedEnv(gym.Env):
    """
       ### Description
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def step(self, u):
        ...
        dt = self.dt
        #perturbation
        g += np.random.normal(0, self.g_std)
...
class PendulumCostEnv(gym.Env):
    ...
    * v0: Initial versions release (1.0.0)
    ...
    def simulate_next_state(self, u):
        th, thdot = self.state  # th := theta
        ...
        return np.array([np.cos(newth), np.sin(newth), newthdot], dtype=np.float32)
        # return self._get_obs()
